...
static int __init usb_8dev_init(void)
{
	int result;
...
static void __exit usb_8dev_exit(void)
{
	/* deregister this driver with the USB subsystem */
	usb_deregister(&usb_8dev_driver);
}

module_init(usb_8dev_init);
module_exit(usb_8dev_exit);
